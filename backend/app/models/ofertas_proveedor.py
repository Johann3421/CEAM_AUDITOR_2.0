...
class OfertaProveedorHistory(Base):
    ...
    estado_ficha_producto = Column(String, index=True, nullable=True)
    estado_oferta = Column(String, index=True, nullable=True)
    motivo_estado = Column(Text, nullable=True)
    justificacion_estado = Column(Text, nullable=True)
    id_producto_ofertado = Column(String, index=True, nullable=True)
